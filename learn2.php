...
<div id="Div3" style="display: block;">
  <table>
      <td> 
        ...
        <p class="bubble speech" contenteditable>
       <a>Selamat pagi <a id="nametext">ddd</a></a>
        </p>
          <img
          src="Teacher.svg"
          alt="Teacher"
      ...
      <td>    
        <p class="bubble speech" contenteditable>
          <a>Selamat <span style="font-weight: bold;" id="daylearn">malam</span> Joyo</a>
           </p>
          <img
          src="Leanr.svg"
          alt="Learn"
...
<div id="Div4" style="display: none;">
    <H1 id="GuessWord"></H1>
    <input id="Choice1" onclick="myFunction()" type="button" value="to mention"> </input>
    <input id="Choice1" type="button" value="to sit"></input>
    <input id="Choice1" type="button" value="laughing"></input>
    <input id="Choice1" type="button" value="Square"></input>    
</div> -->


<script>
    //document.getElementById("daylearn").value="hhh";
...
function gettimeofday(now) {
	...
	if (hour >= 0 && hour < 5) {
        ...
        document.getElementById("daylearn").innerHTML="pagi";
	}
	if (hour >= 5 && hour < 12) {
	...
	if (hour >= 12 && hour < 15) {
		...
		document.getElementsByClassName('simtime')[0].style.color = "#7a6021";
        document.getElementById("daylearn").innerHTML="siang";
	}
    if (hour >= 15 && hour < 19) {
		timeofdaypercent = hour - 12;
		timeofdaypercent = (timeofdaypercent / 7) * 100;
		...
		document.getElementsByClassName('simtime')[0].style.color = "#7a6021";
        document.getElementById("daylearn").innerHTML="sore";
	}
	if (hour >= 19 && hour <= 24) {
		...
		world.style.borderBottom = "5px solid #67a8f1";
		document.getElementsByClassName('simtime')[0].style.color = "#d3d3d3";
        document.getElementById("daylearn").innerHTML="malam";
	}
}
